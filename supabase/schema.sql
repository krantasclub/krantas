...
-- ── Homepage content ─────────────────────────────────────────────────────────
-- The scrolling strip below the header and the text-only "statement" section
-- between the Videos and Gallery carousels on the homepage. Same singleton
-- pattern as about_page, editable from /admin/homepage.
